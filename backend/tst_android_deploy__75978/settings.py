"""
Django settings for tst_android_deploy__75978 project.
...
ROOT_URLCONF = 'tst_android_deploy__75978.urls'
...
WSGI_APPLICATION = 'tst_android_deploy__75978.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_android_deploy__75978 API",
    "DESCRIPTION": "API documentation for tst_android_deploy__75978 App",
    "VERSION": "v1",
}
